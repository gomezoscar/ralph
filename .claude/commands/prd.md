...
1. Receive a feature description from the user (provided as $ARGUMENTS or ask if not provided)
...
Each story should be small enough to implement in one focused session (fits in one context window).
