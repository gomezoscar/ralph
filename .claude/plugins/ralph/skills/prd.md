...
**Critical for Ralph:** Each story should be small enough to implement in one context window. This is essential for autonomous execution.
...
**Acceptance Criteria:**
- [ ] Task card shows colored priority badge
